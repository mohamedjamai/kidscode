...
export async function POST() {
  try {
    ...
    `);
    console.log('Difficulty levels table created');
    ...
    await executeQuery(`
      INSERT IGNORE INTO difficulty_levels (name, level, description) VALUES
    ...
    `);
    console.log('Default difficulty levels inserted');

    // Insert sample lessons
    await executeQuery(`
      INSERT IGNORE INTO lessons (title, description, content, difficulty_level_id, lesson_type, order_number) VALUES
